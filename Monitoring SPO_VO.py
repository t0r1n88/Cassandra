...
def procent_cell(cell):
    """
    ФУнкция для обработки значений вида 4 из 8
    :param cell:
    :return:
    """
    if cell is None:
    ...
    data = cell.split()
    if len(data) == 3:
        return str(int(data[0]) / int(data[2]))
    else:
        return cell
...
col_d = ['Name','Средняя оценка обучающимися по программам СПО удовлетворенности качеством посещенных профориентационных мероприятий',
         'Средняя оценка студентами вузов удовлетворенности качеством посещенных профориентационных мероприятий',
         'Количество обучающихся по программам СПО, удовлетворенных качеством посещенных профориентационных мероприятий','Общее число представителей возрастной категории) Вопрос 52',
         'Количество студентов вузов, удовлетворенных качеством посещенных профориентационных мероприятий','Общее число представителей возрастной категории) Вопрос 53',
         'Средняя оценка удовлетворенности выбранным профилем/направлением получаемого образования обучающимися по программам СПО','Средняя оценка удовлетворенности выбранным профилем/направлением получаемого образования студентами вузов',
         'Количество обучающихся по программам СПО, удовлетворенных выбранным профилем/направлением получаемого образования','Общее число представителей возрастной категории) Вопрос 56',
         'Количество студентов вузов, удовлетворенных выбранным профилем/направлением получаемого образования','Общее число представителей возрастной категории) Вопрос 57',
         'Средняя оценка обучающимися по программам СПО удовлетворенности своей текущей профессиональной траекторией','Средняя оценка студентами вузов удовлетворенности своей текущей профессиональной траекторией'
    ,'Количество обучающихся по программам СПО, удовлетворенных своей текущей профессиональной траекторией','Общее число представителей возрастной категории) Вопрос 60',
         'Количество студентов вузов, удовлетворенных своей текущей профессиональной траекторией','Общее число представителей возрастной категории) Вопрос 61',
         'Средняя оценка обучающимися по программам СПО удовлетворенности своей планируемой профессиональной траекторией','Средняя оценка студентами вузов удовлетворенности своей планируемой профессиональной траекторией',
         'Количество обучающихся по программам СПО, удовлетворенных своей планируемой профессиональной траекторией','Общее число представителей возрастной категории) Вопрос 64',
         'Количество студентов вузов, удовлетворенных своей планируемой профессиональной траекторией','Общее число представителей возрастной категории) Вопрос 65']
...
d = {'Наличие  мероприятий, направленных на профессиональное самоопределение и профориентацию обучающихся по программам СПО и студентов вузов':0,
    ...
    'Количество и доля обучающихся по программам СПО и студентов вузов, охваченных практико-ориентированными программами по направлению профессионального самоопределения и профориентации(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},
    'Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос тридцать девять':
    ...
    'Количество и доля обучающихся по программам СПО и студентов вузов, охваченных программами дополнительного образования по освоению компетенций Ворлдскиллс Россия на базе средних общеобразовательных организации, профессиональных образовательных организации и образовательных организации высшего образования, организациях дополнительного образования, а также иных площадках, оборудованных в соответствии с инфраструктурными листами и обеспечивающими подготовку по стандартам Ворлдскиллс Россия(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

     'Количество и доля обучающихся по программам СПО и студентов вузов, принявших участие в мероприятиях по направлению профессионального самоопределения и профориентации Центра опережающей профессиональной подготовки (далее – ЦОПП)(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},
     'Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок один':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории, относящихся к категории инвалидов (детей-инвалидов) и лиц с ограниченными возможностями здоровья)':0},

    'Количество и доля обучающихся по программам СПО и студентов вузов, принявших участие в мероприятиях по направлению профессионального самоопределения и профориентации на базе современных мастерских, созданных в рамках реализации мероприятия «Государственная поддержка профессиональных образовательных организации в целях обеспечения соответствия их материально-технической базы современным требованиям» федерального проекта «Молодые профессионалы (Повышение конкурентоспособности профессионального образования)» национального проекта «Образование»(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},
    'Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок два':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории, относящихся к категории инвалидов (детей-инвалидов) и лиц с ограниченными возможностями здоровья)':0},

    'Количество и доля обучающихся по программам СПО и студентов вузов, прошедших стажировку и/или практическое обучение на предприятиях(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},
    'Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок три':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории, относящихся к категории инвалидов (детей-инвалидов) и лиц с ограниченными возможностями здоровья)':0},

    'Количество и доля обучающихся по программам СПО, направление обучения которых при поступлении в организации среднего профессионального образования соответствует приоритетному направлению, выявленному при предшествующем мониторинге в общеобразовательном учреждении (среднее за 2016-2021)(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

    'Количество и доля студентов вузов, направление обучения которых при поступлении в вуз соответствует приоритетному направлению, выявленному при предшествующем мониторинге в общеобразовательном учреждении (среднее за 2016-2021)(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},
    'Место мероприятий по направлению профессионального самоопределения и профориентации среди факторов, оказавших влияние на профессиональный выбор первокурсников организации среднего профессионального образования':'',
     46:'',
     'Место мероприятий по направлению профессионального самоопределения и профориентации среди факторов, оказавших влияние на профессиональный выбор первокурсников вузов':'',
    47:'',

    'Количество и доля выпускников организации среднего профессионального образования, трудоустроенных по полученным профессиям и специальностям в течение года после окончания обучения':
         {'Количество (чел.)':0,'Доля (% от общего количества выпускников организации среднего профессионального образования, трудоустроенных в течение года после окончания обучения)':0},

    48:0,

    'Количество и доля выпускников вузов, трудоустроенных по полученным профессиям и специальностям в течение года после окончания обучения':
         {'Количество (чел.)':0,'Доля (% от общего количества выпускников вузов, трудоустроенных в течение года после окончания обучения)':0},
     49:0,

     'Средняя оценка обучающимися по программам СПО удовлетворенности качеством посещенных профориентационных мероприятий':0,
    50:0,
    'Средняя оценка студентами вузов удовлетворенности качеством посещенных профориентационных мероприятий':0,
    51:0,
    'Количество и доля обучающихся по программам СПО, удовлетворенных качеством посещенных профориентационных мероприятий(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

     'Количество и доля студентов вузов, удовлетворенных качеством посещенных профориентационных мероприятий(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

    'Средняя оценка удовлетворенности выбранным профилем/направлением получаемого образования обучающимися по программам СПО':0,
     54:0,

    'Средняя оценка удовлетворенности выбранным профилем/направлением получаемого образования студентами вузов':0,
     55:0,

    'Количество и доля обучающихся по программам СПО, удовлетворенных выбранным профилем/направлением получаемого образования(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

    'Количество и доля студентов вузов, удовлетворенных выбранным профилем/направлением получаемого образования(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

    'Средняя оценка обучающимися по программам СПО удовлетворенности своей текущей профессиональной траекторией':0,
     58:0,

    'Средняя оценка студентами вузов удовлетворенности своей текущей профессиональной траекторией':0,
     59:0,

    'Количество и доля обучающихся по программам СПО, удовлетворенных своей текущей профессиональной траекторией(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

    'Количество и доля студентов вузов, удовлетворенных своей текущей профессиональной траекторией(два показателя)':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

    'Средняя оценка обучающимися по программам СПО удовлетворенности своей планируемой профессиональной траекторией':0,
     62:0,

    'Средняя оценка студентами вузов удовлетворенности своей планируемой профессиональной траекторией':0,
     63:0,

    'Количество и доля обучающихся по программам СПО, удовлетворенных своей планируемой профессиональной траекторией':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0},

    'Количество и доля студентов вузов, удовлетворенных своей планируемой профессиональной траекторией':
         {'Количество (чел.)':0,'Общее число представителей возрастной категории)':0}
...
for file in os.listdir(path):
    ...
    #39
    d['Количество и доля обучающихся по программам СПО и студентов вузов, охваченных практико-ориентированными программами по направлению профессионального самоопределения и профориентации(два показателя)']['Количество (чел.)']+= check_cell(sheet['G128'].value)
    d['Количество и доля обучающихся по программам СПО и студентов вузов, охваченных практико-ориентированными программами по направлению профессионального самоопределения и профориентации(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G129'].value)

    #39a
    d['Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос тридцать девять']['Количество (чел.)']+= check_cell(sheet['G130'].value)
    d['Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос тридцать девять']['Общее число представителей возрастной категории, относящихся к категории инвалидов (детей-инвалидов) и лиц с ограниченными возможностями здоровья)']+= check_cell(sheet['G131'].value)

    #40
    d['Количество и доля обучающихся по программам СПО и студентов вузов, охваченных программами дополнительного образования по освоению компетенций Ворлдскиллс Россия на базе средних общеобразовательных организации, профессиональных образовательных организации и образовательных организации высшего образования, организациях дополнительного образования, а также иных площадках, оборудованных в соответствии с инфраструктурными листами и обеспечивающими подготовку по стандартам Ворлдскиллс Россия(два показателя)']['Количество (чел.)']+= check_cell(sheet['G133'].value)
    d['Количество и доля обучающихся по программам СПО и студентов вузов, охваченных программами дополнительного образования по освоению компетенций Ворлдскиллс Россия на базе средних общеобразовательных организации, профессиональных образовательных организации и образовательных организации высшего образования, организациях дополнительного образования, а также иных площадках, оборудованных в соответствии с инфраструктурными листами и обеспечивающими подготовку по стандартам Ворлдскиллс Россия(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G134'].value)

    #41
    d['Количество и доля обучающихся по программам СПО и студентов вузов, принявших участие в мероприятиях по направлению профессионального самоопределения и профориентации Центра опережающей профессиональной подготовки (далее – ЦОПП)(два показателя)']['Количество (чел.)']+= check_cell(sheet['G136'].value)
    d['Количество и доля обучающихся по программам СПО и студентов вузов, принявших участие в мероприятиях по направлению профессионального самоопределения и профориентации Центра опережающей профессиональной подготовки (далее – ЦОПП)(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G137'].value)
    #41a
    d['Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок один']['Количество (чел.)']+= check_cell(sheet['G138'].value)
    d['Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок один']['Общее число представителей возрастной категории, относящихся к категории инвалидов (детей-инвалидов) и лиц с ограниченными возможностями здоровья)']+= check_cell(sheet['G139'].value)

    #42
    d['Количество и доля обучающихся по программам СПО и студентов вузов, принявших участие в мероприятиях по направлению профессионального самоопределения и профориентации на базе современных мастерских, созданных в рамках реализации мероприятия «Государственная поддержка профессиональных образовательных организации в целях обеспечения соответствия их материально-технической базы современным требованиям» федерального проекта «Молодые профессионалы (Повышение конкурентоспособности профессионального образования)» национального проекта «Образование»(два показателя)']['Количество (чел.)']+= check_cell(sheet['G141'].value)
    d['Количество и доля обучающихся по программам СПО и студентов вузов, принявших участие в мероприятиях по направлению профессионального самоопределения и профориентации на базе современных мастерских, созданных в рамках реализации мероприятия «Государственная поддержка профессиональных образовательных организации в целях обеспечения соответствия их материально-технической базы современным требованиям» федерального проекта «Молодые профессионалы (Повышение конкурентоспособности профессионального образования)» национального проекта «Образование»(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G142'].value)
    #42a
    d['Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок два']['Количество (чел.)']+= check_cell(sheet['G143'].value)
    d['Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок два']['Общее число представителей возрастной категории, относящихся к категории инвалидов (детей-инвалидов) и лиц с ограниченными возможностями здоровья)']+= check_cell(sheet['G144'].value)

    #43
    d['Количество и доля обучающихся по программам СПО и студентов вузов, прошедших стажировку и/или практическое обучение на предприятиях(два показателя)']['Количество (чел.)']+= check_cell(sheet['G146'].value)
    d['Количество и доля обучающихся по программам СПО и студентов вузов, прошедших стажировку и/или практическое обучение на предприятиях(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G147'].value)
    #43a
    d['Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок три']['Количество (чел.)']+= check_cell(sheet['G148'].value)
    d['Из них инвалиды (дети-инвалиды) и лица с ограниченными возможностями здоровья(два показателя) Вопрос сорок три']['Общее число представителей возрастной категории, относящихся к категории инвалидов (детей-инвалидов) и лиц с ограниченными возможностями здоровья)']+= check_cell(sheet['G149'].value)

    #44
    d['Количество и доля обучающихся по программам СПО, направление обучения которых при поступлении в организации среднего профессионального образования соответствует приоритетному направлению, выявленному при предшествующем мониторинге в общеобразовательном учреждении (среднее за 2016-2021)(два показателя)']['Количество (чел.)']+= check_cell(sheet['G152'].value)
    d['Количество и доля обучающихся по программам СПО, направление обучения которых при поступлении в организации среднего профессионального образования соответствует приоритетному направлению, выявленному при предшествующем мониторинге в общеобразовательном учреждении (среднее за 2016-2021)(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G153'].value)

    #45
    d['Количество и доля студентов вузов, направление обучения которых при поступлении в вуз соответствует приоритетному направлению, выявленному при предшествующем мониторинге в общеобразовательном учреждении (среднее за 2016-2021)(два показателя)']['Количество (чел.)']+= check_cell(sheet['G155'].value)
    d['Количество и доля студентов вузов, направление обучения которых при поступлении в вуз соответствует приоритетному направлению, выявленному при предшествующем мониторинге в общеобразовательном учреждении (среднее за 2016-2021)(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G156'].value)

    #46
    d['Место мероприятий по направлению профессионального самоопределения и профориентации среди факторов, оказавших влияние на профессиональный выбор первокурсников организации среднего профессионального образования']+=f'{sheet["G158"].value};'
    d[46] += f'{procent_cell(sheet["G158"].value)};'

    #47
    d['Место мероприятий по направлению профессионального самоопределения и профориентации среди факторов, оказавших влияние на профессиональный выбор первокурсников вузов']+=f'{sheet["G160"].value};'
    d[47] += f'{procent_cell(sheet["G160"].value)};'

    #48
    d['Количество и доля выпускников организации среднего профессионального образования, трудоустроенных по полученным профессиям и специальностям в течение года после окончания обучения']['Количество (чел.)']+= check_cell(sheet['G162'].value)
    d[48]+= check_cell(sheet['G163'].value)
    d['Количество и доля выпускников организации среднего профессионального образования, трудоустроенных по полученным профессиям и специальностям в течение года после окончания обучения']['Доля (% от общего количества выпускников организации среднего профессионального образования, трудоустроенных в течение года после окончания обучения)']= d[48] / count

    #49
    d['Количество и доля выпускников вузов, трудоустроенных по полученным профессиям и специальностям в течение года после окончания обучения']['Количество (чел.)']+= check_cell(sheet['G165'].value)
    d[49]+= check_cell(sheet['G165'].value)
    d['Количество и доля выпускников вузов, трудоустроенных по полученным профессиям и специальностям в течение года после окончания обучения']['Доля (% от общего количества выпускников вузов, трудоустроенных в течение года после окончания обучения)']= d[49] / count

    #50
    d[50]+= check_cell(sheet['G178'].value)
    d['Средняя оценка обучающимися по программам СПО удовлетворенности качеством посещенных профориентационных мероприятий']= d[54] / count

    #51
    d[51]+= check_cell(sheet['G178'].value)
    d['Средняя оценка студентами вузов удовлетворенности качеством посещенных профориентационных мероприятий']=d[51] / count

    #52
    d['Количество и доля обучающихся по программам СПО, удовлетворенных качеством посещенных профориентационных мероприятий(два показателя)']['Количество (чел.)']+= check_cell(sheet['G172'].value)
    d['Количество и доля обучающихся по программам СПО, удовлетворенных качеством посещенных профориентационных мероприятий(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G173'].value)

    #53
    d['Количество и доля студентов вузов, удовлетворенных качеством посещенных профориентационных мероприятий(два показателя)']['Количество (чел.)']+= check_cell(sheet['G175'].value)
    d['Количество и доля студентов вузов, удовлетворенных качеством посещенных профориентационных мероприятий(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G176'].value)

    #54
    d[54]+= check_cell(sheet['G178'].value)
    d['Средняя оценка удовлетворенности выбранным профилем/направлением получаемого образования обучающимися по программам СПО']= d[54] / count

    #55
    d[55]+= check_cell(sheet['G180'].value)
    d['Средняя оценка удовлетворенности выбранным профилем/направлением получаемого образования студентами вузов']= d[55] / count

    #56
    d['Количество и доля обучающихся по программам СПО, удовлетворенных выбранным профилем/направлением получаемого образования(два показателя)']['Количество (чел.)']+= check_cell(sheet['G182'].value)
    d['Количество и доля обучающихся по программам СПО, удовлетворенных выбранным профилем/направлением получаемого образования(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G183'].value)

    #57
    d['Количество и доля студентов вузов, удовлетворенных выбранным профилем/направлением получаемого образования(два показателя)']['Количество (чел.)']+= check_cell(sheet['G185'].value)
    d['Количество и доля студентов вузов, удовлетворенных выбранным профилем/направлением получаемого образования(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G186'].value)

    #58
    d[58]+= check_cell(sheet['G188'].value)
    d['Средняя оценка обучающимися по программам СПО удовлетворенности своей текущей профессиональной траекторией']= d[58] / count

    #59
    d[59]+= check_cell(sheet['G190'].value)
    d['Средняя оценка студентами вузов удовлетворенности своей текущей профессиональной траекторией']= d[59] / count

    #60
    d['Количество и доля обучающихся по программам СПО, удовлетворенных своей текущей профессиональной траекторией(два показателя)']['Количество (чел.)']+= check_cell(sheet['G192'].value)
    d['Количество и доля обучающихся по программам СПО, удовлетворенных своей текущей профессиональной траекторией(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G193'].value)

    #61
    d['Количество и доля студентов вузов, удовлетворенных своей текущей профессиональной траекторией(два показателя)']['Количество (чел.)']+= check_cell(sheet['G195'].value)
    d['Количество и доля студентов вузов, удовлетворенных своей текущей профессиональной траекторией(два показателя)']['Общее число представителей возрастной категории)']+= check_cell(sheet['G196'].value)

    #62
    d[62]+= check_cell(sheet['G198'].value)
    d['Средняя оценка обучающимися по программам СПО удовлетворенности своей планируемой профессиональной траекторией']= d[62] / count

    #63
    d[63]+= check_cell(sheet['G200'].value)
    d['Средняя оценка студентами вузов удовлетворенности своей планируемой профессиональной траекторией']= d[63] / count

    #64
    d['Количество и доля обучающихся по программам СПО, удовлетворенных своей планируемой профессиональной траекторией']['Количество (чел.)']+= check_cell(sheet['G202'].value)
    d['Количество и доля обучающихся по программам СПО, удовлетворенных своей планируемой профессиональной траекторией']['Общее число представителей возрастной категории)']+= check_cell(sheet['G203'].value)

    #65
    d['Количество и доля студентов вузов, удовлетворенных своей планируемой профессиональной траекторией']['Количество (чел.)']+= check_cell(sheet['G205'].value)
    d['Количество и доля студентов вузов, удовлетворенных своей планируемой профессиональной траекторией']['Общее число представителей возрастной категории)']+= check_cell(sheet['G206'].value)


    count += 1
    name_file = file.split('.')[0]

    new_row ={'Name':name_file,
              'Средняя оценка обучающимися по программам СПО удовлетворенности качеством посещенных профориентационных мероприятий':sheet['G168'].value,
              'Средняя оценка студентами вузов удовлетворенности качеством посещенных профориентационных мероприятий':sheet['G170'].value,
              'Количество обучающихся по программам СПО, удовлетворенных качеством посещенных профориентационных мероприятий':sheet['G172'].value,
              'Общее число представителей возрастной категории) Вопрос 52':sheet['G173'].value,
              'Количество студентов вузов, удовлетворенных качеством посещенных профориентационных мероприятий':sheet['G175'].value,
             'Общее число представителей возрастной категории) Вопрос 53':sheet['G176'].value,
             'Средняя оценка удовлетворенности выбранным профилем/направлением получаемого образования обучающимися по программам СПО':sheet['G178'].value,
             'Средняя оценка удовлетворенности выбранным профилем/направлением получаемого образования студентами вузов':sheet['G180'].value,
             'Количество обучающихся по программам СПО, удовлетворенных выбранным профилем/направлением получаемого образования':sheet['G182'].value,
             'Общее число представителей возрастной категории) Вопрос 56':sheet['G183'].value,
             'Количество студентов вузов, удовлетворенных выбранным профилем/направлением получаемого образования':sheet['G185'].value,
             'Общее число представителей возрастной категории) Вопрос 57':sheet['G186'].value,
             'Средняя оценка обучающимися по программам СПО удовлетворенности своей текущей профессиональной траекторией':sheet['G188'].value,
             'Средняя оценка студентами вузов удовлетворенности своей текущей профессиональной траекторией':sheet['G190'].value,
             'Количество обучающихся по программам СПО, удовлетворенных своей текущей профессиональной траекторией':sheet['G192'].value,
             'Общее число представителей возрастной категории) Вопрос 60':sheet['G193'].value,
             'Количество студентов вузов, удовлетворенных своей текущей профессиональной траекторией':sheet['G195'].value,
             'Общее число представителей возрастной категории) Вопрос 61':sheet['G196'].value,
             'Средняя оценка обучающимися по программам СПО удовлетворенности своей планируемой профессиональной траекторией':sheet['G198'].value,
    'Средняя оценка студентами вузов удовлетворенности своей планируемой профессиональной траекторией':sheet['G199'].value,
             'Количество обучающихся по программам СПО, удовлетворенных своей планируемой профессиональной траекторией':sheet['G202'].value,
             'Общее число представителей возрастной категории) Вопрос 64':sheet['G203'].value,
             'Количество студентов вузов, удовлетворенных своей планируемой профессиональной траекторией':sheet['G205'].value,
             'Общее число представителей возрастной категории) Вопрос 65':sheet['G206'].value
}

    miss_df = miss_df.append(new_row,ignore_index=True)
print(d)

with open('SPO and VO.txt','w',encoding='utf-8') as file:
    for key,value in d.items():
        file.write(f'{key}\n, {value}\n\n')
miss_df.to_excel('3.3 Удовлетворенность результатами профориентационной работы СПО и ВО.xlsx',index=False)